...
function show_down($android,$cell_android,$iphone,$ipad){
	switch (device()){
		...
		default:
			$down .= "<p class='icon'>";
			if($android){
				$down .= '<span><a href="'.$android.'" target="_blank" data-original-title="Android" ><img src="__PUBLIC__/images/product/icon_05.png"></a></span>';
			}
			if($iphone){
				$down .= '<span><a href="'.$iphone.'" target="_blank" data-original-title="iPhone"><img src="__PUBLIC__/images/product/icon_06.png"></a></span>';
			}
			if($ipad){
				$down .= '<span><a href="'.$ipad.'" target="_blank" data-original-title="iPad"><img src="__PUBLIC__/images/product/icon_07.png"></a></span>';	
			}
			$down .= "</p>";		
	}
	return $down;
