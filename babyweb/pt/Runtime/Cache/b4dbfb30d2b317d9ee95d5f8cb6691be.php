...
<title>Home - BabyBus - Número 1 em Apps Infantis</title>
</head>
                        ...
                        <div class="page-content-wrapper">
                            ...
                            <h1 class="caption hidden-xs">
                                <small data-wow-delay="1.85s" class="wow fadeInLeft animated">
                                    <p>
                                    	Queremos ser o parceiro da sua criança na divertida jornada do conhecimento. Esperamos poder nos tornar o assessor exclusivo da mamãe e do papai!
                                    </p>
                                </small>
                            </h1>
                        </div>
...
<div class="two">
	<div class="container indexicon">
		<h1 class="caption" style="word-spacing: 0px;">O que é a BabyBus?</h1>
		<p class="vice-caption">Aperfeiçoando o conhecimento, através de métodos divertidos, cultivando as cacidades do seu bebê em diferentes áreas, para nos tornarmos os parceiros de crescimento do seu bebê.</p>
		<div class="row">
			<div class="col-sm-3 col-xs-6 font-center margin-top50"> <img  class="animated" alt="Conhecimento Básico" src="__PUBLIC__/images/home/icon_1.png">
				<h4>Conhecimento Básico</h4>
				<p>Abrem os olhinhos do bebê para o conhecimento</p>
			</div>
			<div class="col-sm-3 col-xs-6 font-center margin-top50"> <img class="animated"  alt="Inteligência Emocional" src="__PUBLIC__/images/home/icon_2.png">
				<h4>Inteligência Emocional</h4>
				<p>Ajudam o bebê a ser o dono das suas emoções</p>
			</div>

			<div class="col-sm-3 col-xs-6 font-center margin-top50"> <img  class="animated"  alt="Criatividade" src="__PUBLIC__/images/home/icon_3.png">
				<h4>Criatividade</h4>
				<p >Desevolvem a imaginação para uma infância colorida</p>
			</div>
			<div class="col-sm-3 col-xs-6 font-center margin-top50"> <img class="animated"  alt="Raciocínio" src="__PUBLIC__/images/home/icon_4.png">
				<h4>Raciocínio</h4>
				<p>Uma tropa para vencer no campo de batalha da inteligência</p>
			</div>
		</div>
		<div class="row ">
			<div class="col-sm-3 col-xs-6 font-center icon-margin-top"> <img class="animated" alt="Ciências Naturais" src="__PUBLIC__/images/home/icon_8.png">
				<h4 >Ciências Naturais</h4>
				<p>Acompanham o bebê a explorar os mistérios da natureza</p>
			</div>
			<div class="col-sm-3 col-xs-6 font-center icon-margin-top"> <img class="animated" alt="Roleplay" src="__PUBLIC__/images/home/icon_5.png">
				<h4>Roleplay</h4>
				<p>Para aprender a refletir jogando</p>
			</div>
			<div class="col-sm-3 col-xs-6 font-center icon-margin-top"> <img class="animated" alt="Hábitos e Comportamentos" src="__PUBLIC__/images/home/icon_7.png">
				<h4>Hábitos e Comportamentos</h4>
				<p>Bons hábitos para a vida futura</p>
			</div>
			<div class="col-sm-3 col-xs-6 font-center icon-margin-top"> <img class="animated" alt="Segurança e Ambiente" src="__PUBLIC__/images/home/icon_6.png">
				<h4>Segurança e Ambiente</h4>
				<p>Se proteger a si mesmo é uma habilidade, proteger o meio ambiente é responsabilidade</p>
			</div>
		</div>
	</div>
</div>
...
<div class="four">
	<div class="container">
		<P>Grupo BabyBus © 2014 Todos os Direitos Reservados<br />
