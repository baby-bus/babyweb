...
function show_down($android,$cell_android,$iphone,$ipad,$pro_key=""){
	switch (device()){
		case "android":
			if($cell_android){
                $ios_url="";
				$down = '<p class="device-icon"><span><a href="#"  onclick="download(\''.$ios_url.'\',\''.$cell_android.'\',\''.$pro_key.'\');" ><img src="__PUBLIC__/images/product/android.png"></a></span></p>';
			}else{
		...
		case "ipad":
			if($ipad){
                $ios_url=$ipad;
				$down = '<p class="device-icon"><span><a href="#"  onclick="download(\''.$ios_url.'\',\''.$cell_android.'\',\''.$pro_key.'\');" ><img src="__PUBLIC__/images/product/apptree.png"></a></span></p>';
		...
		default:
			$down .= "<p class='icon'>";
			if($android){
				$down .= '<span><a href="'.$android.'" target="_blank" data-original-title="Android下载" ><img src="__PUBLIC__/images/product/icon_05.png"></a></span>';
			}
			if($iphone){
				$down .= '<span><a href="'.$iphone.'" target="_blank" data-original-title="iPhone下载"><img src="__PUBLIC__/images/product/icon_06.png"></a></span>';
			}
			if($ipad){
				$down .= '<span><a href="'.$ipad.'" target="_blank" data-original-title="iPad下载"><img src="__PUBLIC__/images/product/icon_07.png"></a></span>';	
			}
			$down .= "</p>";		
	}
	return $down;
...
function get_lang_url($lang){
	...
	switch ($lang){
		case "zh-Hans":
			$url = "http://ba-zh-hans.baby-bus.com/img/zh-Hans/";
			break;
		case "zh-Hant":
			$url = "http://ba-zh-hant.baby-bus.com/img/zh-Hant/";
			break;
		case "en":
			$url = "http://ba-en.baby-bus.com/img/en/";
			break;
		case "de":
			$url = "http://ba-de.baby-bus.com/img/de/";
			break;
		case "ko":
			$url = "http://ba-ko.baby-bus.com/img/ko/";
			break;
		case "ru":
			$url = "http://ba-ko.baby-bus.com/img/ru/";
			break;
		case "ar":
			$url = "http://ba-ko.baby-bus.com/img/ar/";
			break;
		case "ja":
			$url = "http://ba-ja.baby-bus.com/img/ja/";
			break;
		case "fr":
			$url = "http://ba-fr.baby-bus.com/img/fr/";
			break;
		default:
			$url = "http://g2.babybus.org/";
			break;
	}
	return $url;
}
