...
<div class="joinus padding-top70 joinus-banner">
		...
		<div class="container relative">
			<div class="absolutetext hidden-xs">
				<p>加入我们吧，让你的工作成果成为孩子最好的礼物！</p>
				<p>宝宝巴士的小伙伴们享有以下福利：<span class="visible-xs"><br />六险一金+带薪年假+健康体检+不定期员工活动+多样化休闲设施+贴心下午茶</span></p>

				<P class="hidden-xs">期权&nbsp;<big>+</big>六险一金&nbsp;&nbsp;<big>+</big>带薪年假&nbsp;<big>+</big>健康体检&nbsp;<big>+</big>不定期员工活动&nbsp;<big>+</big>多样化休闲设施&nbsp;<big>+</big>贴心下午茶</P>
			</div>
		</div>
...
<div class="container job">
    ...
    <ul class="nav nav-tabs hidden-xs margin-top50">
      ...
      <li>
      	<a class="icon2" href="#chengxuyuan" data-toggle="tab"><P>软件工程师</P>
      ...
      <li>
      	<a class="icon3" href="#cehua" data-toggle="tab"><P>产品策划</P>
      ...
      <li>
      	<a class="icon4" href="#yinxiao" data-toggle="tab"><P>音效师</P>
      ...
      <li>
      	<a class="icon5" href="#tuiguang" data-toggle="tab"><P>大数据</P>
      		<img src="__PUBLIC__/images/joinus/i_shic.png" />
      	</a>
      	<div class="trigon_yellow">						
					</div>
      </li>
    ...
    <div class="tab-content">    
        <div id="meishu" class="row tab-pane fade in active padding-bottom10">
            ...
            <?php if(is_array($data[1])): $i = 0; $__LIST__ = $data[1];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><h3 <?php echo $i==1 ? '':'class="margin-top40"';?>><span class="titleColor1 titleBorder"></span><?php echo ($val['job_name']); ?></h3>
                ...
                <h4 class="font_c_blue margin-top20">岗位职责：</h4>
                <P><?php echo ($val['job_respons']); ?></P>
                <h4 class="font_c_blue margin-top20">岗位要求：</h4>
                <P><?php echo ($val['job_require']); ?></P>
                   <P><a class="btn btn-primary join_btn" href="#"  data-toggle="modal" data-target="#myModal">申请职位</a></P><?php endforeach; endif; else: echo "" ;endif; ?>
             </div>
        </div>
...
<div class="container">
    ...
    <div class="row joinus">
        ...
        <div class="col-sm-6 margin-top50">
        	<p><img src="__PUBLIC__/images/Public/map.png"> 福州市仓山区金工路1号 福州海峡创意产业园9号楼3F 宝宝巴士</p>
            <p><img src="__PUBLIC__/images/Public/email-open.png"> 邮箱: hr@babybus.com  招聘电话：18050156312</p>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">求职申请</h4>
      </div>
    ...
    <div class="row">
    	<div class="col-sm-12">
            ...
            <div class="row">            
                ...
                <span class="hint" id="fileshang">请上传简历doc,docx,wps,zip.文件最大限制2M</span>
            </div>
            <div class="col-sm-4 margin-top10 ">
                <div class="btn-group btn-group2">
                    <select id="job_select" name="job_select" class="form-control form-control2" >
                      <option value="选择申请岗位">选择申请岗位</option>
                ...
                <br/><span class="hint" id="jobhang">请选择岗位</span>
            </div>
