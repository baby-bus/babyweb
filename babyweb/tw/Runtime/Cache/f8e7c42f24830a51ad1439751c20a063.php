	    ...
	    <div class="row">
			...
			<div class="col-xs-12 margin-top40 text-center">
				<a id="down"></a>
	        		...
	        		<a href=<?php echo is_ios() ? "https://itunes.apple.com/cn/artist/bi-hong-lin/id428769096" : U('product/showDownList');?>><img src="__PUBLIC__/images/Public/click_down.png" width="300"></a>
        	...
        	<div class="panel panel-default">
                ...
                <div class="panel-heading clearfix">
                  <h4 class="panel-title">
                      ...
                      <span>Q1</span>iOS设备上其他应用都有声音但是宝宝巴士应用没有?
                ...
                <div id="collapseone" class="panel-collapse collapse in">
                  <div class="panel-body">
                    <P>首先在设备中进行如下操作：“设置”→“侧边开关用于：”→“静音”；然后尝试开下声音按钮旁边的小按钮。</P>
                  </div>
                </div>
              </div>
              ...
              <div class="panel panel-default">
                ...
                <div id="collapseseven" class="panel-collapse collapse">
                  <div class="panel-body">
                    <P>A.设备中的软件开启数量多或者下载的软件太多了，可以利用系统优化程序清理下系统，关闭不必要的应用进程。</P>
                    <p>B.网络环境的不同导致下载的速度，网络环境好，即网速好，下载速度快。</P>
