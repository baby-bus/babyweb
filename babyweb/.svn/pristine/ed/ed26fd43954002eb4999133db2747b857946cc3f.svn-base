			...
			<div class="row joinus">
				<div class="col-md-3 hidden-xs hidden-sm">
					<div class="ist-group margin-top30"style="width: 213px;" data-spy="affix" data-offset-top="60" data-offset-bottom="200">
					  ...
					  <a href="privacyPolicy.shtml" class="list-group-item">개인정보취급방침</a>
					  <a href="link.shtml" class="list-group-item active">관련링크</a>
					</div>
				</div>
				<div class="col-md-9 margin-top10 statements">

					<h3 style="color: #00BAE9;">관련링크</h3>
					<hr />
					<p>
                        링크 신청주소:tanglijun[at]baby-bus.com      [at]를 [@]로 대체
                    </p>
					<hr />
