			...
			<div class="row joinus">
				<div class="col-md-3 hidden-xs hidden-sm">
					<div class="ist-group margin-top30"style="width: 213px;" data-spy="affix" data-offset-top="60" data-offset-bottom="200">
					  ...
					  <a href="declaration.shtml" class="list-group-item">Nutzungsbedingungen</a>
					  <a href="privacyPolicy.shtml" class="list-group-item">Datenschutzerklärung</a>
					  <a href="link.shtml" class="list-group-item active">Linkaustausch</a>
					</div>
				</div>
				<div class="col-md-9 margin-top10 statements">

					<h3 style="color: #00BAE9;">Linkaustausch</h3>
					<hr />
					<p>
                        Bei Anfragen für einen Linkaustausch: tanglijun[at]baby-bus.com ({at} durch @ ersetzen)
					</p>
					<hr />
