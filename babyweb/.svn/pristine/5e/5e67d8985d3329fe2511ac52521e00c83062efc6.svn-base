...
<meta name="description" content="Chez Babybus, l'épanouissement des enfants est notre priorité. C'est pourquoi nous concevons des applications éducatives de qualité, qui, à travers le jeu, sollicitent l'imagination et encouragent la créativité... pour permettre de progresser et de grandir tout en douceur !">
<meta name="keywords" content="BabyBus, éveil, éducation, alphabet, application éducative, panda, maternelle, pédagogie, chiffres, apprendre en s'amusant, progresser, jeux pour enfants, enfant, ABC, couleurs, formes, mémo, dessin,coloriage, peinture, musique">
...
<title>BLOG - BabyBus - Applications éducatives pour grandir en douceur</title>
</head>
<body>
<!--=============navbar导航===================
==============================================-->
...
<div class="container">
	<div class="row">
		<div class="col-sm-9">
			<ol class="breadcrumb">
				<li><a href='__APP__'>Accueil</a></li>
	...
	<div class="row blog">
		...
		<div class="col-sm-4 blog">
                    ...
                    <h4><span style="color: #999999;">Commentaire</span> 
                    ...
                    <p class="text-right margin-top10"><span style="float: left;"></span><a id='submit' class="btn btn-primary" onclick="tosubmit()">Envoyer</a></p>
                    </div>
		</div>
	</div>
</div>
...
<script type='text/javascript'>     
    function scroll(class_name){
		 $(class_name).infinitescroll({
	            ...
	            msgText:"En cours de chargement..."			//加载时显示的文字
				},
