...
class BoxAction extends  CommonAction{
	...
	public function getList($where){
		...
		$result = $this->model->field('id,ipad_id,iphone_id,cell_android_url,android_url,app_name,app_images,intro,myapp_url,myios_url,app_pro_key')->where($where)->order("id desc")->page(''.$page.',9')->select();
