...
<html lang="en">
    ...
    <![endif]-->
		...
		<title>Главная страница - BabyBus - всегда отличные приложения для детей</title>
	</head>
						...
						<div class="one" style="background: url(/Public/images/banner/bg.png) repeat #4db9e2;">
							<div class="page-vertical-align">
                                ...
                                <small data-wow-delay="1.85s" class="wow fadeInLeft animated">
                                    ...
                                    <p>Позвольте нам стать путеводителем по дошкольному обучению для ваших детей, а также эксклюзивным консультантом для мамы и папы.</p>
...
==============================================-->
		<div class="two">
			<div class="container indexicon">
				<h1 class="caption">Зона обучения</h1>
				<p class="vice-caption">BabyBus готов стать вашим лучшим спутником в мире знаний и веселья! Мы предлагаем широкий спектр категорий приложений для обучения и развития детей. </p>
				<div class="row">
					<div class="col-sm-3 col-xs-6 font-center margin-top50">
						<img class="animated" alt="Базовые знания" src="__PUBLIC__/images/home/icon_1.png">
						<h4>Базовые знания</h4>
						<p>Мир знаний - в твоих руках</p>
					</div>
					<div class="col-sm-3 col-xs-6 font-center margin-top50">
						<img class="animated" alt="Эмоциональное развитие" src="__PUBLIC__/images/home/icon_2.png">
						<h4>Эмоциональное развитие</h4>
						<p>Стань хозяином своих эмоций</p>
					</div>

					<div class="col-sm-3 col-xs-6 font-center margin-top50">
						<img class="animated" alt="Творческие способности" src="__PUBLIC__/images/home/icon_3.png">
						<h4>Творческие способности</h4>
						<p>Развивай воображение для красочного детства</p>
					</div>
					<div class="col-sm-3 col-xs-6 font-center margin-top50">
						<img class="animated" alt="Тренировка мышления" src="__PUBLIC__/images/home/icon_4.png">
						<h4>Тренировка мышления</h4>
						<p>Стань победителем на поле боя интеллекта</p>
					</div>
				</div>
				<div class="row ">
					<div class="col-sm-3 col-xs-6 font-center icon-margin-top">
						<img class="animated" alt="Естествознание" src="__PUBLIC__/images/home/icon_8.png">
						<h4>Естествознание</h4>
						<p>Исследуй тайны нашего мира</p>
					</div>
					<div class="col-sm-3 col-xs-6 font-center icon-margin-top">
						<img class="animated" alt="Ролевые игры" src="__PUBLIC__/images/home/icon_5.png">
						<h4>Ролевые игры</h4>
						<p>Примерь на себя разные роли</p>
					</div>
					<div class="col-sm-3 col-xs-6 font-center icon-margin-top">
						<img class="animated" alt="Хорошие привычки" src="__PUBLIC__/images/home/icon_7.png">
						<h4>Хорошие привычки</h4>
						<p>Хорошие привычки остаются на всю жизнь</p>
					</div>
					<div class="col-sm-3 col-xs-6 font-center icon-margin-top">
						<img class="animated" alt="Экология и Безопасность" src="__PUBLIC__/images/home/icon_6.png">
						<h4>Экология и Безопасность</h4>
						<p>Защити себя и окружающий тебя мир</p>
					</div>
				</div>
			</div>
		</div>
...
<div class="four">
	<div class="container">
        <?php if($link_data != null): ?><p>Рекомендуемые ссылки：
                ...
                <a href="<?php echo U('Index/link');?>">Еще больше</a>
            </p><?php endif; ?>
